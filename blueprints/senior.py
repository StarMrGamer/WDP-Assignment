...
@senior_bp.route('/stories/<int:story_id>/delete', methods=['POST', 'DELETE'])
@login_required
...
@senior_bp.route('/api/messages/<int:message_id>/edit', methods=['POST'])
@csrf.exempt
@login_required
...
@senior_bp.route('/events/suggest', methods=['GET', 'POST'])
@login_required
def suggest_event():
    """Suggest a new event."""
    if request.method == 'POST':
        ...
        try:
            ...
            return redirect(url_for('senior.suggest_event'))
    ...
    return render_template('senior/suggest_event.html')
...
@senior_bp.route('/communities/suggest', methods=['GET', 'POST'])
@login_required
def suggest_community():
    ...
    if request.method == 'POST':
        ...
        if not name or not comm_type or not reason:
            ...
            return redirect(url_for('senior.suggest_community'))
    ...
    return render_template('senior/suggest_community.html')
